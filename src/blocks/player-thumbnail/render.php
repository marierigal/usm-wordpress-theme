...
<article class="usm-player wp-block-group is-style-column-box-shadow">
  ...
  <div class="usm-player__info wp-block-group has-base-color has-main-background-color">
    ...
    <?php if ($age): ?>
      <p class="usm-player__info__age">
        <?php echo $age; ?> <span
          class="usm-player__info__label"
        ><?php echo __('ans', 'usm'); ?></span>
      </p>
    <?php endif; ?>
    ...
    <?php if ($height || $weight): ?>
      <p class="usm-player__info__body">
        <?php if ($height): ?>
          <?php echo $height; ?> <span
            class="usm-player__info__label"
          ><?php echo __('cm', 'usm'); ?></span>
        <?php endif; ?>
        ...
        <?php if ($weight): ?>
          <?php echo $weight; ?> <span
            class="usm-player__info__label"
          ><?php echo __('kg', 'usm'); ?></span>
        <?php endif; ?>
      </p>
    <?php endif; ?>
