...
class Player
{
  ...
  private const ADMIN_COLUMN_NAME_POSITION = 'taxonomy-position';
  ...
  public static function manage_columns(array $post_columns): array
  {
    ...
    return array_merge(
      ...
      [self::ADMIN_COLUMN_NAME_POSITION => $post_columns[self::ADMIN_COLUMN_NAME_POSITION]],
  ...
  {
    $sortable_columns[self::ADMIN_COLUMN_NAME_POSITION] = [
      self::ADMIN_COLUMN_NAME_POSITION,
      false,
