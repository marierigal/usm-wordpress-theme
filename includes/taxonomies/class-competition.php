...
class Competition
{
  ...
  public const TAXONOMY_NAME = 'competition';
  ...
  public static function register_taxonomy(): void
  {
    register_taxonomy(self::TAXONOMY_NAME, self::POST_TYPE_NAMES, [
      'labels'            => [
        ...
        'name'                       => _x('Competitions', 'Taxonomy label', 'usm'),
        /* translators: Singular name for the taxonomy. Default 'Tag'/'Category'. */
        'singular_name'              => _x('Competition', 'Taxonomy label', 'usm'),
        /* translators: Default ‘Search Tags'/'Search Categories’. */
        'search_items'               => _x('Search Competitions', 'Taxonomy label', 'usm'),
        /* translators: Default ‘Popular Tags'/'Popular Categories’. */
        'popular_items'              => _x('Popular Competitions', 'Taxonomy label', 'usm'),
        /* translators: Default ‘All Tags'/'All Categories’. */
        'all_items'                  => _x('All Competitions', 'Taxonomy label', 'usm'),
        /* translators: This label is only used for hierarchical taxonomies. Default ‘Parent Category’. */
        'parent_item'                => _x('Parent Competition', 'Taxonomy label', 'usm'),
        /* translators: The same as parent_item, but with colon : in the end. */
        'parent_item_colon'          => _x('Parent Competition:', 'Taxonomy label', 'usm'),
        /* translators: Default ‘Edit Tag'/'Edit Category’. */
        'edit_item'                  => _x('Edit Competition', 'Taxonomy label', 'usm'),
        /* translators: Default ‘View Tag'/'View Category’. */
        'view_item'                  => _x('View Competition', 'Taxonomy label', 'usm'),
        /* translators: Default ‘Update Tag'/'Update Category’. */
        'update_item'                => _x('Update Competition', 'Taxonomy label', 'usm'),
        /* translators: Default ‘Add New Tag'/'Add New Category’. */
        'add_new_item'               => _x('Add New Competition', 'Taxonomy label', 'usm'),
        /* translators: Default ‘New Tag Name'/'New Category Name’. */
        'new_item_name'              => _x('New Competition Name', 'Taxonomy label', 'usm'),
        ...
        'separate_items_with_commas' => _x('Separate competitions with commas', 'Taxonomy label', 'usm'),
        ...
        'add_or_remove_items'        => _x('Add or remove competitions', 'Taxonomy label', 'usm'),
        ...
        'item_link_description'      => _x('A link to a competition', 'Taxonomy label', 'usm'),
      ],
      'public'            => true,
      'show_in_menu'      => true,
      ...
      'capabilities'      => [
        'manage_terms' => 'manage_competitions',
        'edit_terms'   => 'manage_competitions',
        'delete_terms' => 'manage_competitions',
